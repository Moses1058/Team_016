...
//add event listener onclick when menu button is clicked nav bar appears button changes with close button and when close button is clicked nav bar dissadears
